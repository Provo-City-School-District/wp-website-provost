...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-130781213-4"></script>
	<script>
...
<body>
	...
	<header id="mainHeader">
		<a href="<?php bloginfo('url'); ?>"><img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/header-logo.png'; ?>" alt="Elem" id="siteLogo" />
			<h1>Provost Elementary School</h1>
		</a>
		<aside>
			<ul class="sociallinks">
				<li><a href="https://www.instagram.com/provost_elementary/"><img src="<?php echo get_template_directory_uri() . '/assets/icons/socialmedia-instagram-white.svg' ?>" alt="Link to Instagram" /></span>
					</a>
				</li>
				<li><a href="https://twitter.com/@provostsm"><img src="<?php echo get_template_directory_uri() . '/assets/icons/socialmedia-twitter-white.svg' ?>" alt="Link to Twitter" /></span>
					</a>
				</li>
				<li><a href="http://facebook.com/provostelementary"><img src="<?php echo get_template_directory_uri() . '/assets/icons/socialmedia-facebook-white.svg' ?>" alt="Link to Facebook" /></span>
					</a>
				</li>
			</ul>
			<!-- Search Form -->
			...
			<ul class="contactinfo" itemscope itemtype="https://schema.org/PostalAddress">
				<li><span itemprop="streetAddress">629 South 900 East</span><span itemprop="addressLocality"> Provo</span>, <span itemprop="addressRegion">Utah</span> <span itemprop="postalCode">84606</span><span class="phone" itemprop="telephone"> Phone: (801) 374-4960</span><span class="fax" itemprop="faxNumber"> Fax: (801) 374-4962</span>
			</ul>
